...
function fnExpireDateValueRemove(){
	$("#expireDate").val('');
}
							...
							<table class="table table-bordered table-striped th_left" summary="회원 등록">
						        <tbody>
						            ...
						            <tr>
						                ...
						                <th>만료일자</th>
						                <td><input name="expireDate" id="expireDate" type="text" readonly="readonly" value="<c:out value="${expireDate }" />" /><button class="btn btn-mini" id="postFind" onclick="fnExpireDateValueRemove();return false;">초기화</button></td>
						            </tr>
						        </tbody>
					    	</table>
						</form:form>
