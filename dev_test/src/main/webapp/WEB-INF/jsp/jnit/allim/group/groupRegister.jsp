					...
					<div class="widget-content nopadding">
						<form:form commandName="jnitallimGroupVO">
							...
							<table class="table table-bordered table-striped th_left" summary="그룹 테이블">
								...
								<c:if test="${type == 'banner' || type == 'allim' }">
								<tr>
									<th>배너 정렬 유형&nbsp;<a href="javascript:Jnit_allim_question('10');"><i class="icon-question-sign"></i></a></th>
									<td>
										<form:select path="groupOrderType" id="groupOrderType">
											<form:option value="1" label="기본" />
											<form:option value="2" label="최신순" />
											<form:option value="3" label="이름순" />
										</form:select>
										 
										<div id="JnitAllimQuestion10" style="display: none;">
											<strong>&nbsp;- 배너를 표시할 정렬 방법 (기본:아이탬의 정렬순서|최신순:최근 등록순서|이름순:이미지 ALT순서)</strong>
										</div>	
									</td>
								</tr>
								<tr>
