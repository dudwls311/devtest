...
<script type="text/javascript" src="/resources/js/exts/com/grpMenuAuth/list.js"></script>
					...
					<form name="searchForm" id="searchForm" action="?" >
						...
						<div class="search_glist">
							...
							<c:forEach items="${groupList }" var="group">
								<li data-authgrpid="<c:out value="${group.typeId }" />" data-grpnm="<c:out value="${group.typeNm }" />">
									<c:out value="${group.typeNm }" />
								</li>
							</c:forEach>
							</ul>
						</div>
					...
					<div class="cell_box">
						<table class="c_tit ">
							<tr>
								<th scope="row">그룹명</th>
								<td id="grpNmTd"></td>
								<td><button class="btn_st btn_c_gr" type="button" id="saveBtn">저장</button></td>
							</tr>
						</table>
