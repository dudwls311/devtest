...
<form id="writePageForm" action="?">
	...
	<input type="hidden" id="cdMode" name="cdMode" value="" />
			...
			<div class="con_b_tp">
				...
				<table class="table_style thd_v_m">
					...
					<c:forEach var="result" items="${resultList}" varStatus="status">
						...
						<tr>
							<td><a href="#" onclick="javascript:fnView('<c:out value="${result.deptId}" />');return false;"><c:out value="${result.deptId}" /></a></td>
