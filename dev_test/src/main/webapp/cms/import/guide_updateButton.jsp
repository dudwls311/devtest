...
<%@ include file="/_common/header.jsp" %>
		...
		<%
			String admId = CmsServletPathProperty.getProp(servletPath,"admId");
			String admId2 = CmsServletPathProperty.getProp(servletPath,"admId2");
		...
		<c:set var="admId" value="<%= admId %>"/>
		<c:set var="admId2" value="<%= admId2 %>"/>
