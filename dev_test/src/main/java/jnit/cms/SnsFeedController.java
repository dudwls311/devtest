...
public class SnsFeedController {
    ...
    public String twitterTimeline(
    		...
    		String latestPath = Globals.CONTEXT_PATH + SEPERATOR + "sns" + SEPERATOR + "twitter.json";
	    	String latestDirPath = Globals.CONTEXT_PATH + SEPERATOR + "sns";
    ...
    public String naverGetRss(
	    	...
	    	String latestPath = Globals.CONTEXT_PATH + SEPERATOR + "sns" + SEPERATOR + "naverblog.json";
	    	String latestDirPath = Globals.CONTEXT_PATH + SEPERATOR + "sns";
	    	File dataFile = new File(latestPath);
    		Boolean hasFile = false;
    		File latestDir = new File(latestDirPath);
