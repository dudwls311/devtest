...
import jnit.board.info.history.JnitboardinfoHistoryService;
import jnit.board.info.history.JnitboardinfoHistoryVO;
...
public class JnitboardinfoController {
    ...
    throws Exception {
    	...
    	try{
    		...
    		JnitboardinfoHistoryVO historyVO = new JnitboardinfoHistoryVO();
    		historyVO.setBoardId(jnitboardinfoVO.getBoardId());
    		historyVO.setBoardGroup(jnitboardinfoVO.getBoardGroup());
    		historyVO.setBoardTitle(jnitboardinfoVO.getBoardTitle());
    		historyVO.setAction(mode);
//    		historyVO.setActionDate(actionDate);
    		historyVO.setActionIp(request.getRemoteAddr());
    		historyVO.setMbrId(loginVO.getMbrId());
    		jnitboardinfoHistoryService.insertJnitboardinfoHistory(historyVO);
    ...
    public static String getBoardPath(HttpServletRequest request){
    	String boardPath = Globals.CONTEXT_PATH + SEPERATOR + BOARD_PATH;
    	return boardPath;
    }
    ...
    public static String getBoardInfoPath(HttpServletRequest request){
    	...
    	//String boardInfoPath = Globals.CONTEXT_PATH + SEPERATOR + BOARD_INFO_PATH;
    	String boardInfoPath = Globals.CONTEXT_PATH + SEPERATOR + BOARD_INFO_PATH;
