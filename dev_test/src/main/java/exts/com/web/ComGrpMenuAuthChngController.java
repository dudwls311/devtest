...
import exts.com.service.ComGrpMenuAuthChngService;
 ...
 */
@Controller
public class ComGrpMenuAuthChngController extends ExtsAbstractController{
	
	protected String getPkg(){return "exts/com/grpMenuAuthChng";}
	 ...
	 * 분기문
	 */
	@RequestMapping(value="/exts/com/grpMenuAuthChng/index.do")
	public String index(
		...
		setIndexProcess(EnumMenuCd.COM_GROUP_MENU_HST, searchVO.getCgmcMode());				//분기공통처리
		request.setAttribute(REQUEST_ACTION_URL, "/exts/com/grpMenuAuthChng/index.do");
		
		StringBuilder sb = new StringBuilder("forward:");
		sb.append("/exts/com/grpMenuAuthChng/" + searchVO.getCgmcMode() + ".do");
	 ...
	 * 리스트
	 */
	@RequestMapping(value="/exts/com/grpMenuAuthChng/list.do")
	public String list(
		...
		return "exts/com/grpMenuAuthChng/list";
	}
