...
public class ComLoginMenuVO implements Serializable{
	...
	public String toString() {
		return "ComLoginMenuVO [menuSn=" + menuSn + ", menuNm=" + menuNm + ", menuUrl=" + menuUrl + ", uprMenuSn="
				+ uprMenuSn + ", menuLvlVl=" + menuLvlVl + ", menuSeq=" + menuSeq + ", menuExplnt=" + menuExplnt
