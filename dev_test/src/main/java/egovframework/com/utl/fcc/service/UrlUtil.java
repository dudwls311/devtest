...
public class UrlUtil {
	...
	public static String currentContextUrl(HttpServletRequest request){
		StringBuffer ret = new StringBuffer(request.isSecure()?"https://":"http://");
		ret.append(request.getServerName());
		if((!request.isSecure() && request.getServerPort() != 80) || (request.isSecure() && request.getServerPort() != 443))ret.append(":").append(request.getServerPort());
		return ret.toString();
	}
