...
import exts.com.validator.ComAuthGrpValidator;
import exts.com.vo.ComAuthGrpVO;


/**
 * @Class Name : ComAuthGrpController.java
 * @Description : 그룹 Controller - cms type으로 처리.
 ...
 */
//@Controller
public class ComAuthGrpController extends ExtsAbstractController{
	
	protected String getPkg(){return "exts/com/authGrp";}
	 ...
	 * 분기문
	 */
	@RequestMapping(value="/exts/com/authGrp/index.do")
	public String index(
		...
		setIndexProcess(EnumMenuCd.COM_AUTH_GRP, searchVO.getCoagMode());				//분기공통처리
		request.setAttribute(REQUEST_ACTION_URL, "/exts/com/authGrp/index.do");

		StringBuilder sb = new StringBuilder("forward:");
		sb.append("/exts/com/authGrp/" + searchVO.getCoagMode() + ".do");
	 ...
	 * 리스트
	 */
	@RequestMapping(value="/exts/com/authGrp/list.do")
	public String list(
...
//		setListDefaultCondition(searchVO);
		...
		return "exts/com/authGrp/list";
	}

	/**
	 * 뷰 Json
	 */
	@RequestMapping(value="/exts/com/authGrp/viewJson.do")
...
//		model.addAttribute("isModifiable",comAuthGrpService.isModifiable(result));
	 ...
	 * 삭제
	 */
	@RequestMapping(value="/exts/com/authGrp/deleteActionJson.do")
	 ...
	 * 추가 / 수정 처리
	 */
	@RequestMapping(value="/exts/com/authGrp/writeActionJson.do")
	 ...
	 * 리스트 JSON
	 */
	@RequestMapping(value="/exts/com/authGrp/listJson.do")
