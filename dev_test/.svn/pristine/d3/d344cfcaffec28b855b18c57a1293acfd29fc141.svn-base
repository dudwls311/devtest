...
public class JnitrscpageController {
    ...
    public String jnitrscJspPageView(@ModelAttribute("searchVO") JnitrscpageDefaultVO searchVO,
			...
			String mkFileDir = Globals.CONTEXT_PATH+"WEB-INF/jsp/jnit/rsc/";
			String filePath = "";
			String codefilePath = "";
    ...
    public void createdFile (HttpServletRequest request,JnitcmssiteVO siteVO) throws Exception{
		...
		try {
			...
			String setSubDir = Globals.CONTEXT_PATH+"WEB-INF/jsp/jnit/rsc/Uaddpage.jsp";
		...
		try {
			...
			String setSubCodeDir = Globals.CONTEXT_PATH+"WEB-INF/jsp/jnit/rsc/Uaddpage_code.jsp";
		...
		try {
			...
			String setSubDir = Globals.CONTEXT_PATH+"WEB-INF/jsp/jnit/rsc/upPage.jsp";
			String setSubSrc = CmsHandler.readFile(setSubDir);
		...
		try {
			...
			String setSubCodeDir = Globals.CONTEXT_PATH+"WEB-INF/jsp/jnit/rsc/upPage_code.jsp";
			String setSubCodeSrc = CmsHandler.readFile(setSubCodeDir);
