...
public class JnitFilegoUtil {
	...
	public static void deleteFile(JnitFilegoFileType fileType, String path) {
		JnitFilegoSendUtil.deleteFile(fileType, path);
	}
	 ...
	 * @param file
	 */
	public static void renameFile(JnitFilegoFileType fileType, File srcFile, File dstFile) {
		renameFile(fileType, srcFile.getPath(), dstFile.getPath());
	}
	 ...
	 * @param srcFile
	 */
	public static void renameFile(JnitFilegoFileType fileType, String srcFile, String dstFile) {
		JnitFilegoSendUtil.renameFile(fileType, srcFile, dstFile);
	}
