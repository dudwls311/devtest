...
public class CmsPageViewController {
    ...
    public String fileView(
    	...
    	String docRoot = Globals.CONTEXT_PATH;
    	...
    	if(bindType.equals("bannerRolling")) {
    		...
    		String mkFileDir = Globals.CONTEXT_PATH+"WEB-INF/jsp/jnit/cms/menu/sitemenu";
    		...
    		try {
    			...
    			String setSubCodeDir = Globals.CONTEXT_PATH+"/cms/import/updateButton_code.jsp";
				String setSubCodeSrc = CmsHandler.readFile(setSubCodeDir);
    ...
    public String fileSave(
    	...
    	if(bindType.equals("bannerRolling")) {
    		...
    		try {
    			...
    			String setSubDir = Globals.CONTEXT_PATH+"WEB-INF/jsp/jnit/cms/menu/sub.jsp";
    ...
    public String fileSavebackup(
    	...
    	if(bindType.equals("bannerRoll")) {
    		...
    		try {
    			...
    			String setSubOriginCodeDir = Globals.CONTEXT_PATH+"WEB-INF/jsp/jnit/cms/menu/_original_sub_code.jsp";
