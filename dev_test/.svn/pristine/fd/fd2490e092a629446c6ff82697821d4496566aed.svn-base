...
public class CpfBoardEmpValidator extends ExtsAbstractValidator implements Validator {
	...
	private static final String positionId = "positionId";		//직급
	private static final String deptId = "deptId";		//부서
	...
	public void validate(final Object obj, final Errors errors) {
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors,positionId, REQUIRED_FIELD, makeMessage(positionId, REQUIRED_FIELD));		//직급
		ValidationUtils.rejectIfEmptyOrWhitespace(errors,deptId, REQUIRED_FIELD, makeMessage(deptId, REQUIRED_FIELD));		//부서
